...
//     <Grid container  className="contact_us_page">
//     <Grid item xs={12} md={12} style={{background:'orange'}}>
// 1
// </Grid>
// <Grid item xs={12} md={12} style={{background:'green'}}>
// 2
//       </Grid>
//       <Grid item xs={12} md={12} style={{ textAlign: "center" ,background:'pink' }}>
// <h1 className="typography_heading">
//   Partner with us for excellence in every endeavor
// </h1>
// <h3 className="homepageSubhead">
//   Send us a message if you're ready to explore possibilities or request
//   a demo.
// </h3>
//       </Grid>

//       <Grid item xs={12} md={8} style={{background:'orange'}} className="contact_us_form">
...
function ContactUs() {
  ...
  return (
    <>
      <div className="homeContainer">
        <Grid container className="gfg">
          <Grid item xs={12} className="contact_us_top_container">
            <h1 className="typography_heading">
              Partner with us for excellence in every endeavor
            </h1>
            <h3 className="homepageSubhead">
