              ...
              <Slide direction="right" triggerOnce={true} duration={1500}>
                ...
                <article className="azureServicesContent">
                  <Typography variant="p" align="justify">
                    ...
                    connected but also safeguarded with robust security
                    measures.
                  </Typography>
                </article>
              ...
              <Slide direction="left" triggerOnce={true} duration={1500}>
                ...
                <article className="azureServicesContent">
                  <Typography variant="p" align="justify">
                    ...
                    services empower you to create, publish, and manage APIs
                    that provide secure and controlled access to your IoT data.
                    Whether you're exposing data to partners, customers, or
                    internal applications, we ensure your APIs are secure,
              ...
              <Slide direction="right" triggerOnce={true} duration={1500}>
                ...
                <article className="azureServicesContent">
                  <Typography variant="p" align="justify">
                    ...
                    expertise, you can design and deploy scalable, real-time
                    data pipelines that extract valuable insights from your data
          ...
          <Grid container className="azure_services_container">
            <Grid item xs={12} md={6}>
              <Slide direction="left" triggerOnce={true} duration={1500}>
                ...
                <article className="azureServicesContent">
                  <Typography variant="p" align="justify">
                    Efficiency is paramount in IoT operations. Our Azure
                    Functions development services allow you to automate data
                    processing, analysis, and actions in response to IoT events.
                    We create custom Azure Functions that seamlessly integrate
                    with your Azure IoT environment, ensuring streamlined
                    workflows and optimized operations..
                  </Typography>
                </article>
              ...
              <Slide direction="right" triggerOnce={true} duration={1500}>
                ...
                <article className="azureServicesContent">
                  <Typography variant="p" align="justify">
                    ...
                    analyzing, and visualizing time-stamped data generated by
                    IoT devices. Our experts assist you in setting up and
                    configuring Time Series Insights environments, enabling you
                    to efficiently store, explore, and interpret time-series
